# mapping PrcbuildDrEnv from prcbuild_dr_dailyrun as a class
class PrcbuildDrDailyrun < ActiveRecord::Base
  # Overview
  ...
  self.table_name = 'prcbuild_dr_dailyrun'
  ...
  # ----------------------
  # in sqlplus
  # >desc PRCQA.PRCBUILD_DR_DAILYRUN@FARMJANGO
