class RptheadController < ApplicationController
  def index

    @Rpthead = Rpthead.where(product_id: '4332').last(100)
    ...
    # Rendered rpthead/index.html.haml within layouts/application (0.8ms)
    ...
    # Rendered rpthead/index.html.haml within layouts/application (0.1ms)
